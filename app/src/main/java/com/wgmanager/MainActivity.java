...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView ivStatusDot, ivVpnBg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivVpnBg = findViewById(R.id.ivVpnBg);
        ...
        if (serverManager.getServers().isEmpty()) {
            serverManager.addServer(new Server("NL-AMS-01", "Netherlands, Amsterdam", "nl"));
        }
    ...
    private void updateConnectionState() {
        if (isConnected) {
            ivVpnBg.setImageResource(R.drawable.ic_vpn_button_green);
            ...
            ivVpnBg.setImageResource(R.drawable.ic_vpn_button_red);
